...
const LoginCard = () => {
  return (
    <div className='flex flex-col bg-white w-[50%] h-[100%] justify-center'>
        ...
        <form action="" className='space-y-[27px] mt-[32px]'>
            ...
            <p className='font-urbanist font-medium text-[14px]'>By Logging in, I Acknowledge that I have read and agree to the <Link href='#' className='text-[#08284E]' >Terms and Conditions </Link> and <Link href='#' className='text-[#08284E]'>Privacy Policy</Link></p>
            <button type='button' className='w-full h-[54px] bg-buttons text-white rounded-[5px]'>Log In</button>
            <button type='button' className='w-full rounded-[5px] border border-[#08284E] h-[50px] text-[18px] font-medium font-urbanist text-[#08284E] mt-[48px]'>Open a MonieFlex Bank Account</button>
        </form>
        </div>
    </div>
  )
